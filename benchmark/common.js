...
function Benchmark (fn, configs, options) {
  ...
  var parsedArgs = this._parseArgs(process.argv.slice(2), configs)
...
Benchmark.prototype._queue = function (options) {
  ...
  function recursive (keyIndex, prevConfig) {
    ...
    values.forEach((value) => {
      if (typeof value !== 'number' && typeof value !== 'string') { throw new TypeError(`configuration "${key}" had type ${typeof value}`) }
...
Benchmark.prototype._run = function () {
  ...
  (function recursive (queueIndex) {
    ...
    var child = childProcess.fork(require.main.filename, childArgs, {
      env: childEnv,
